...
<head>
    ...
    <title>Editar Tarefa - Task App</title>
    <link rel="stylesheet" href="<?= base_url('assets/style.css') ?>">
</head>
<body>
    <div class="access-card">
        <h2 class="fw-bold mb-4 text-center text-primary">Editar Tarefa</h2>
        
        <form method="POST" action="<?= url_to('TaskController::update', $task['id']) ?>">
            <?= csrf_field() ?>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="description" name="description" rows="4" placeholder="Descreva a tarefa..."><?= old('description', $task['description']) ?></textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="datetime-local" class="form-control" id="due_date" name="due_date" value="<?= old('due_date', $task['due_date']) ?>">
            </div>
            ...
            <div class="d-grid gap-2">
                <button type="submit" class="btn btn-primary fw-600">
                    <i class="bi bi-check-circle me-2"></i> Atualizar Tarefa
                </button>
