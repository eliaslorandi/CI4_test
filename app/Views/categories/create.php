...
<head>
    ...
    <title>Criar Categoria - Task App</title>
    <link rel="stylesheet" href="<?= base_url('assets/style.css') ?>">
</head>
<body>
    <div class="access-card">
        <h2 class="fw-bold mb-4 text-center text-primary">Criar Nova Categoria</h2>
        
        <form method="POST" action="<?= url_to('CategoryController::store') ?>">
            <?= csrf_field() ?>

            <div class="mb-4">
                <label for="name" class="form-label fw-600">Nome da Categoria <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="name" name="name" value="<?= old('name') ?>" required placeholder="Ex: Trabalho, Pessoal, Estudo">
